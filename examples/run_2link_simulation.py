#!/usr/bin/env python3
"""
Example script for running 2-link manipulator simulation.

This script demonstrates how to use the LLM Controller package to simulate
a 2-link robotic manipulator with adaptive control.
"""
...
def main():
    """Run 2-link manipulator simulation."""
    print("="*80)
    ...
    plot_results(results[0], output_dir='./output_2link')
    print("  ✓ Static plots saved to ./output_2link/results.png")
    
    # Optionally create animation (requires ffmpeg)
    try:
        print("  Creating animation (this may take a moment)...")
        create_animation(results[0], runner.l1, runner.l2, 
                        output_path='./output_2link/animation.mp4', fps=30)
    except Exception as e:
